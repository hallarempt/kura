# Form implementation generated from reading ui file 'frmtagtype.ui'
#
...
class frmtagtypecode(QDialog):
    def __init__(self,parent = None,name = None,modal = 0,fl = 0):
        ...
        self.resize(QSize(394,293).expandedTo(self.minimumSizeHint()))
    ...
    def languageChange(self):
        ...
        self.rdbValue.setText(self.tr("Type a shortish value (searchable)"))
        ...
        self.rdbNote.setText(self.tr("Type a longish note (not searchable)"))
